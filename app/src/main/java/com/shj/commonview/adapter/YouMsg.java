...
public class YouMsg implements ItemViewDelegate<Message>{
    private Context context;
    public YouMsg(Context context){
        this.context = context;
    }
    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent) {
        return ViewHolder.createViewHolder(context,parent,R.layout.simple_rv_content_item);
    }
